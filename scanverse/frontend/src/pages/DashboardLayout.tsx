...
function MobileTopBar({ onOpenMenu }: { onOpenMenu: () => void }) {
  return (
    <header className="flex items-center justify-between border-b border-line-light bg-white/80 px-4 py-3 backdrop-blur dark:border-line-dark dark:bg-ink/70 lg:hidden">
